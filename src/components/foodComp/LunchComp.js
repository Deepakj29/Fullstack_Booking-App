...
import useFetch from "../../hooks/useFetch";
 ...
 export const LunchComp =()=>{
    const { data, loading, error } = useFetch("http://localhost:4000/api/v1/lunchMenu/show");
    
    const images = [
        "../Assets/food/meals.jpg",
        "../Assets/food/sambar-rice-recipe.jpg",
        "../Assets/food/curdrice.jpg",
